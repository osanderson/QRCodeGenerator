...
#include "OSQRDataStyle.h"
#import "OSQRFinderStyle.h"

NS_ASSUME_NONNULL_BEGIN



@interface OSQRRender : NSObject
...
-(void)setDataStyle:(NSObject<OSQRDataStyle>*)iStyleHandler;
-(void)setFinderStyle:(NSObject<OSQRFinderStyle>*)iStyleHandler;

// NB iSizePc may be reduced
